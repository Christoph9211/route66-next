    ...
    return (
        ...
        >
            <div
                ...
                aria-hidden
            />
            <div className="relative overflow-y-auto max-h-full w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-4 shadow-xl dark:border-gray-700 dark:bg-gray-800">
