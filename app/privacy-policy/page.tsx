  ...
  return (
    <>
      <main className="policy-content safe-area-bottom">
        ...
        <h2 className="mb-2 mt-6 font-semibold">Information We Collect</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-2 mt-6 font-semibold">How We Use Information</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-2 mt-6 font-semibold">Sharing Information</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-2 mt-6 font-semibold">Governing Law; Dispute Resolution</h2>
        <p className="mb-4">
